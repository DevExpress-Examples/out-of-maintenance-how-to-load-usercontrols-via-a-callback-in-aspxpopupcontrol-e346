<%@ Control Language="vb" AutoEventWireup="true" CodeFile="UserControl2.ascx.vb" Inherits="ASPxperience_PopupControl_HowToLoadUserControlViaCallback_UserControl2" %>
